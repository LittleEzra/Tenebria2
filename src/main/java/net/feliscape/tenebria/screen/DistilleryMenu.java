...
import net.feliscape.tenebria.advancements.criterion.ModCriteriaTriggers;
import net.feliscape.tenebria.block.ModBlocks;
import net.feliscape.tenebria.block.entity.DistilleryBlockEntity;
...
public class DistilleryMenu extends AbstractContainerMenu {
    ...
    public DistilleryMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data){
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 56, 13)); // Input Slot
            this.addSlot(new DistilleryFuelSlot(this, iItemHandler, 1, 56, 53)); // Fuel Slot
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 116, 53){
                ...
                public ItemStack safeInsert(ItemStack pStack) {
                    return super.safeInsert(pStack, 1);
                }
            }); // Bottle Slot
        });
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.DISTILLERY.get());
    }
